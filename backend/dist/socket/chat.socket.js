...
const createChatServer = (server) => {
    ...
    io.on("connection", (socket) => {
        ...
        const emitToTargetUser = (orgId, targetUserId, eventName, payload) => {
            const targetSocketIds = (0, chat_store_1.getSocketIdsForUser)(orgId, targetUserId);
        ...
        socket.on(CHAT_CALL_OFFER_EVENT, (payload) => {
        ...
        socket.on(CHAT_CALL_ANSWER_EVENT, (payload) => {
            const { orgId, fromUserId, fromUserName, targetUserId, videoEnabled, sdp } = payload;
            if (!orgId || !fromUserId || !fromUserName || !targetUserId || !sdp) {
        ...
        socket.on(CHAT_CALL_ICE_EVENT, (payload) => {
